 ...
 */
final class Version20240215195032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE smfn_api_key (api_key VARCHAR(64) NOT NULL, title VARCHAR(36) NOT NULL, owner VARCHAR(36) NOT NULL, project VARCHAR(36) NOT NULL, endDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_subscription_active BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(api_key))');
        ...
        $this->addSql('CREATE TABLE smfn_project (id UUID NOT NULL, owner_id UUID NOT NULL, subscription_id UUID NOT NULL, title VARCHAR(36) NOT NULL, description VARCHAR(256) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C5C08EAF7E3C61F9 ON smfn_project (owner_id)');
        $this->addSql('CREATE INDEX IDX_C5C08EAF9A1887DC ON smfn_project (subscription_id)');
        $this->addSql('CREATE UNIQUE INDEX subscription_project ON smfn_project (subscription_id, title)');
        ...
        $this->addSql('COMMENT ON COLUMN smfn_project.subscription_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE smfn_subscription (id UUID NOT NULL, subscriber_id UUID DEFAULT NULL, subscription_plan_id UUID DEFAULT NULL, endDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE smfn_subscription_plan_offer (subscription_plan_id UUID NOT NULL, offer_id UUID NOT NULL, PRIMARY KEY(subscription_plan_id, offer_id))');
        $this->addSql('CREATE INDEX IDX_59A1167A9B8CE200 ON smfn_subscription_plan_offer (subscription_plan_id)');
        $this->addSql('CREATE INDEX IDX_59A1167A53C674EE ON smfn_subscription_plan_offer (offer_id)');
        $this->addSql('COMMENT ON COLUMN smfn_subscription_plan_offer.subscription_plan_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN smfn_subscription_plan_offer.offer_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE smfn_project ADD CONSTRAINT FK_C5C08EAF9A1887DC FOREIGN KEY (subscription_id) REFERENCES smfn_subscription (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE smfn_subscription_plan_offer ADD CONSTRAINT FK_59A1167A9B8CE200 FOREIGN KEY (subscription_plan_id) REFERENCES smfn_subscription_plan (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE smfn_subscription_plan_offer ADD CONSTRAINT FK_59A1167A53C674EE FOREIGN KEY (offer_id) REFERENCES smfn_offer (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE smfn_project DROP CONSTRAINT FK_C5C08EAF9A1887DC');
        ...
        $this->addSql('ALTER TABLE smfn_subscription_plan_offer DROP CONSTRAINT FK_59A1167A9B8CE200');
        $this->addSql('ALTER TABLE smfn_subscription_plan_offer DROP CONSTRAINT FK_59A1167A53C674EE');
        ...
        $this->addSql('DROP TABLE smfn_subscription_plan_offer');
